      ...
      <div className="p-6 max-w-lg space-y-5">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 rounded-xl border text-sm font-medium transition-colors ${
                  type === t.value
                    ...
                    : 'bg-white border-[#e8e3d8] text-[#6a7e6a] hover:border-brand-400 hover:text-brand-600'
                }`}
              >
        ...
        <Card>
          ...
          <textarea
            ...
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-400 resize-none"
          />
        </Card>
